...
export class PreciosComponent {
  readonly combos: ComboRow[] = [
    { item: 'COMBO BUÑUELOS 1 (5 BUÑUELOS)', price: '$5.000' },
    { item: 'COMBO BUÑUELOS 2 (5 BUÑUELOS + CAFÉ/TINTO)', price: '$5.500' },
    { item: 'COMBO BUÑUELOS RELLENOS 1 (4 BUÑUELOS RELLENOS)', price: '$5.000' },
    { item: 'COMBO BUÑUELOS RELLENOS 2 (4 BUÑUELOS Y 1 CAFÉ/TINTO)', price: '$5.500' },
    { item: 'COMBO EMPANADAS 1 (3 EMPANADAS)', price: '$9.000' },
    { item: 'COMBO EMPANADAS 2 (3 EMPANADAS + VASO DE GASEOSA)', price: '$9.500' },
